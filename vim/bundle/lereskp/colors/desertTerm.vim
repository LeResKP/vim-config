...
" Modified By: Rémy Mouëza <remy@gymglish.com>

" This is a mix of the desert colorscheme by Hans Fugal with the function
" found in the desert256 by Henry So, Jr to have the same color in a terminal
" and the gui with some minor tweaks. 
...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
    ...
    call <SID>X("Normal", "bebebe", "333333", "")
    ...
    "Directory
    "DiffAdd
    call <SID>X("DiffChange", "", "222a30", "")
    "DiffDelete
    call <SID>X("DiffText", "", "225533", "")
    "ErrorMsg
    ...
    " auto completion
    call <SID>X("Pmenu", "", "006f44", "")
    call <SID>X("PmenuSel", "000000", "7f7f7f", "")
